    ...
    <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-img card-img__max" style="background-image: url({{$post->img ?? asset('img/current.jpg')}})"></div>
                        ...
                        <div class="card-btn">
                            ...
                            <form action="{{route('post.destroy', ['id' =>$post->post_id])}}" method="post"
                                  onsubmit="if (confirm('Do you want delete post?')){return true}else {return false}">
                                @csrf
                                @method('DELETE')
